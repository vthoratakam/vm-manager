...
type VMRequest struct {
	...
	ControlContext []byte                 `protobuf:"bytes,3,opt,name=control_context,json=controlContext,proto3" json:"control_context,omitempty"`
...
func (x *VMRequest) GetControlContext() []byte {
	if x != nil {
